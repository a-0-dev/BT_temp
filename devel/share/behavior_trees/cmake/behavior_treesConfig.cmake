...
if("TRUE" STREQUAL "TRUE")
  set(behavior_trees_SOURCE_PREFIX /home/hoebler/catkin_ws/src/behavior_trees)
  set(behavior_trees_DEVEL_PREFIX /home/hoebler/catkin_ws/devel)
  ...
  set(behavior_trees_INSTALL_PREFIX /home/hoebler/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'hoebler <hoebler@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'behavior_trees' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'behavior_trees' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hoebler/catkin_ws/src/behavior_trees/${idir}'.  ${_report}")
    endif()
...
set(behavior_trees_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${behavior_trees_dep}_FOUND)
      find_package(${behavior_trees_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${behavior_trees_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
