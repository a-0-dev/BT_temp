...
"""autogenerated by genpy from behavior_tree_core/BTActionResult.msg. Do not edit."""
import sys
...
class BTActionResult(genpy.Message):
  _md5sum = "9297369affac35d2e9175b6fdde27add"
  _type = "behavior_tree_core/BTActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','behavior_tree_core/BTResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BTActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = behavior_tree_core.msg.BTResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = behavior_tree_core.msg.BTResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.result.status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.status,) = _get_struct_i().unpack(str[start:end])
      return self
